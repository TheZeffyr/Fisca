...
class CategoryRepository(BaseRepository[Category]):
    ...
    async def get_all(self) -> list[Category]:
        """Get all categories from the system (personal + global).
    ...
    async def get_by_user_and_type(
        ...
        """
        return await self._get_many(user_id=user_id, transaction_type=transaction_type)
    ...
    async def get_available_for_user_and_type(
        ...
        global_categories = await self._get_many(
            user_id=None, transaction_type=transaction_type
        )
        return personal_categories + global_categories
