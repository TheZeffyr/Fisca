...
class TransactionRepository(BaseRepository[Transaction]):
    ...
    async def get_user_balance(self, user_id: int) -> int:
        ...
        query = select(total_income, total_expense).where(
    ...
    async def get_by_month(self, user_id: int, month: date) -> list[Transaction]:
        ...
        return await self._get_many(
            user_id=user_id, date__gte=start_date, date__lt=end_date, order_by="-date"
        )
    ...
    async def get_by_category(
        ...
        """
        return await self._get_many(
            user_id=user_id, category_id=category_id, order_by="-date"
        )
